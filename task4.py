...
for i in [rfr,gb,ad]:
  ...
  if abs(train_score-test_score)<=0.2:
    ...
    print("Mean Square Error Is ",mean_absolute_error(y_pred,y_test))
    print("Root Mean Square Error IS ",(mean_squared_error(y_pred,y_test,squared=False)))

from sklearn.neighbors import KNeighborRegressor
from sklearn.svm import SVR
from sklearn.tree import DecisionTreeRegressor

from sklearn.metrics import r2_score_absolute_error,mean_square_error
knn=KNeighborsRegressior()
svr=SVR()
...
rfr=RandomFofestRegressor(n_estimators=10,max_features='sqrt',max_depth=None)
